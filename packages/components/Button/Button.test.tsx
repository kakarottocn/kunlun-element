...
import type { ButtonType, ButtonSize } from "./Button.ts";
...
describe("Button.vue", () => {
  ...
  it("should has the correct type class when type prop is set", () => {
    ...
    types.forEach((type) => {
      ...
      expect(wrapper.classes()).toContain(`kl-button--${type}`);
    });
  });
  ...
  it("should has the correct size class when size prop is set", () => {
    ...
    sizes.forEach((size) => {
      ...
      expect(wrapper.classes()).toContain(`kl-button--${size}`);
    });
  });
...
describe("ButtonGroup.vue", () => {
  test("basic button group", async () => {
    ...
    expect(wrapper.classes()).toContain("kl-button-group");
  });
  ...
  test("button group size", () => {
    ...
    sizes.forEach((size) => {
      ...
      expect(buttonWrapper.classes()).toContain(`kl-button--${size}`);
    });
  });
  ...
  test("button group type", () => {
    ...
    types.forEach((type) => {
      ...
      const buttonWrapper = wrapper.findComponent(Button);
      expect(buttonWrapper.classes()).toContain(`kl-button--${type}`);
    });
  });
